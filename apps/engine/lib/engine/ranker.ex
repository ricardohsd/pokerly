defmodule Engine.Ranker do
  ...
  def rank([head | tail]),
    do: do_rank(tail, categorize(head), [head])

  defp do_rank([first | rest], best_hand, winners) do
    hand = categorize(first)

    case do_compare(hand, best_hand) do
      -1 -> do_rank(rest, best_hand, winners)
      0 -> do_rank(rest, best_hand, [first | winners])
      1 -> do_rank(rest, hand, [first])
    end
  end

  defp do_rank([], _, winners), do: Enum.reverse(winners)

  def compare(hand_1, hand_2),
    do: do_compare(categorize(hand_1), categorize(hand_2))
  ...
  defp analyze([{rank_1, _}, {rank_1, _}, {rank_1, _}, {rank_1, _}, {rank_2, _}]),
    do: {:four_of_a_kind, {rank_1, rank_2}}

  # four of a kind, higher rank
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_2, _}, {rank_2, _}, {rank_2, _}]),
    do: {:four_of_a_kind, {rank_2, rank_1}}

  # full house, higher rank
  defp analyze([{rank_1, _}, {rank_1, _}, {rank_1, _}, {rank_2, _}, {rank_2, _}]),
    do: {:full_house, {rank_1, rank_2}}

  # full house, lesser rank
  defp analyze([{rank_1, _}, {rank_1, _}, {rank_2, _}, {rank_2, _}, {rank_2, _}]),
  ...
  # straight
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_3, _}, {rank_4, _}, {rank_5, _}])
       when rank_2 == rank_1 + 1 and
              rank_3 == rank_2 + 1 and
              rank_4 == rank_3 + 1 and
              rank_5 == rank_4 + 1,
  ...
  defp analyze([{rank_1, _}, {rank_1, _}, {rank_1, _}, {rank_2, _}, {rank_3, _}]),
    do: {:three_of_a_kind, {rank_1, rank_3, rank_2}}

  # three of a kind, lesser rank
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_3, _}, {rank_3, _}, {rank_3, _}]),
    do: {:three_of_a_kind, {rank_3, rank_2, rank_1}}

  # three of a kind, higher and lesser rank
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_2, _}, {rank_2, _}, {rank_3, _}]),
    do: {:three_of_a_kind, {rank_2, rank_3, rank_1}}

  # two pair, + a higher ranking card
  defp analyze([{rank_1, _}, {rank_1, _}, {rank_2, _}, {rank_2, _}, {rank_3, _}]),
    do: {:two_pair, {rank_2, rank_1, rank_3}}

  # two pair, + a lesser ranking card
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_2, _}, {rank_3, _}, {rank_3, _}]),
    do: {:two_pair, {rank_3, rank_2, rank_1}}

  # two pair
  defp analyze([{rank_1, _}, {rank_1, _}, {rank_2, _}, {rank_3, _}, {rank_3, _}]),
    do: {:two_pair, {rank_3, rank_1, rank_2}}

  # one pair, mid + 2 higher ranking cards
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_2, _}, {rank_3, _}, {rank_4, _}]),
    do: {:one_pair, {rank_2, rank_4, rank_3, rank_1}}

  # one pair, mid + 2 lesser ranking cards
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_3, _}, {rank_3, _}, {rank_4, _}]),
    do: {:one_pair, {rank_3, rank_4, rank_2, rank_1}}

  # one pair, bottom
  defp analyze([{rank_1, _}, {rank_1, _}, {rank_2, _}, {rank_3, _}, {rank_4, _}]),
    do: {:one_pair, {rank_1, rank_4, rank_3, rank_2}}

  # one pair, top
  defp analyze([{rank_1, _}, {rank_2, _}, {rank_3, _}, {rank_4, _}, {rank_4, _}]),
