defmodule Pokerly.RankerTest do
    ...
    test "categorize an one pair, pair at mid bottom" do
      assert Pokerly.Ranker.categorize(@mid_bottom_one_pair) == {:one_pair, {7, 9, 8, 5}}
    end

    test "categorize an one pair, pair at mid top" do
      assert Pokerly.Ranker.categorize(@mid_top_one_pair) == {:one_pair, {7, 8, 5, 4}}
    end
    ...
    test "high card Aces" do
      ...
      #assert Pokerly.Ranker.rank(hand) == @high_ace
    end
  end
